...
export default function BasicAlerts() {
  return (
    <div className="ParentBox">
      ...
      <div className="alertContainer error">
        <div className="iconContainer">
          <ListItemIcon>
      ...
      <div className="alertContainer success">
        <div className="iconContainer">
          <ListItemIcon>
      ...
      <div className="noLabelAlertContainer noLabelInfo">
      ...
      <div className="noLabelAlertContainer noLabelError">
        <div className="noLabelIconContainer">
          <ListItemIcon>
            <WarningAmberOutlinedIcon />
          </ListItemIcon>
      ...
      <div className="noLabelAlertContainer noLabelSuccess">
        <div className="noLabelIconContainer">
          <ListItemIcon>
            <CheckCircleOutlineOutlinedIcon />
          </ListItemIcon>
